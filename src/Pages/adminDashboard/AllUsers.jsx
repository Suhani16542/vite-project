...
export default function AllUsers() {
  ...
  return (
    <div className="p-4 md:p-6 space-y-6 w-full bg-white min-h-screen">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="bg-black text-white rounded-lg p-4 flex items-center gap-4 shadow-lg">
        ...
        <table className="min-w-full bg-white rounded-lg shadow border">
          ...
          <thead className="bg-green-600 text-white">
            <tr>
              ...
              <th className="px-4 py-3 text-left text-green-200">Role</th>
          ...
          <tbody className="bg-black text-white">
            {filteredUsers.map((user) => (
              ...
              >
                ...
                {/* ROLE – DARK GREEN */}
                <td className="px-4 py-2 font-semibold text-green-400 capitalize">
                  {user.role}
                </td>
